...
namespace forexcel2
{
	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			string filepath =
				@"C:\Users\lg686\Desktop\DefensiveDungeon\Documents\Table_List";
			...
			//	"03_Enemy_Table.xlsx"
			//	"04_Skill_Table.xlsx"
			//	"05_BuffCC_Table.xlsx"
			//	"06_Synergy_Table.xlsx"
			//	"07_Stage_Table.xlsx"
			//	"08_StageEnemy_Table.xlsx"
			//	"09_Level_Table.xlsx"
			//	"10_Shop_Table.xlsx"
			//	"11_Prefab_Table.xlsx"
			#endregion

			string filename = "11_Prefab_Table";


			#region 시트 이름 (복사용)
			//	"Devil_Table", "Tower_Table", "Enemy_Table"
			//	"SkillCondition_Table", "SkillStat_Table"
			//	"BuffCC_Table", "Synergy_Table"
			//	"Stage_Table", "StageEnemy_Table"
			//	"Level_Table", "Shop_Table"
			//	"Prefab_Table", "Icon_Table", "Sound_Table"
			#endregion

			// 2. 뽑고자 하는 테이블의 시트 이름 설정
			string sheet = "Sound_Table";
